class PowersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @power.save
        format.html { redirect_to @power, notice: 'Poder adicionado com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @power.update(power_params)
        format.html { redirect_to @power, notice: 'Poder atualizado com sucesso.' }
  ...
  def destroy
    @power.destroy
    respond_to do |format|
      format.html { redirect_to powers_url, notice: 'Poder excluído com sucesso.' }
